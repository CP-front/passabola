...
const Home = () => {
  ...
  const handleParticiparClick = () => {
    if (isAuthenticated) {
      // Se está logado, navega para a página de exploração
      navigate("/explorar");
    } else {
    ...
    <section className="bg-gray-100 text-center px-6 py-16">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="mt-8 flex justify-center space-x-4">
          ...
          {/* --- 4. APLICAR A NOVA FUNÇÃO onClick --- */}
          <button 
            onClick={handleParticiparClick} 
            className="flex items-center gap-2 px-6 py-3 rounded-md font-medium text-white bg-gradient-to-r from-purple-600 to-pink-500 shadow hover:opacity-90 transition transform hover:scale-105 hover:shadow-lg cursor-pointer"
          >
